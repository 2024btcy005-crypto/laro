...
export const mockDailyItemsProducts = {
    'ds1': [
        ...
        { id: 'dp1_lays_blue', name: "Lay's Magic Masala (Blue)", description: 'Spicy and aromatic Indian masala chips (Blue pack).', price: 10, isAvailable: true, imageUrl: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?q=80&w=500&auto=format&fit=crop', isVeg: true },
        { id: 'dp1_lays_green', name: "Lay's Cream & Onion (Green)", description: 'Smooth cream and onion crispy chips (Green pack).', price: 10, isAvailable: true, imageUrl: 'https://images.unsplash.com/photo-1527661591475-527312dd65f5?q=80&w=500&auto=format&fit=crop', isVeg: true },
        { id: 'dp1_lays_yellow', name: "Lay's Classic Salted (Yellow)", description: 'Classic golden salted potato chips (Yellow pack).', price: 10, isAvailable: true, imageUrl: 'https://images.unsplash.com/photo-1566478433002-3f746643c14a?q=80&w=500&auto=format&fit=crop', isVeg: true },
        { id: 'dp1_lays_orange', name: "Lay's Spanish Tomato Tango (Orange)", description: 'Sweet and tangy tomato potato chips (Orange pack).', price: 10, isAvailable: true, imageUrl: 'https://images.unsplash.com/photo-1601004890684-d8cbf643f5f2?q=80&w=500&auto=format&fit=crop', isVeg: true },
        { id: 'dp1_maggi', name: 'Maggi 2-Minute Masala Noodles', description: 'Classic 2-minute instant masala noodles.', price: 15, isAvailable: true, imageUrl: 'https://images.unsplash.com/photo-1612927608282-b280ff17540a?q=80&w=500&auto=format&fit=crop', isVeg: true },
